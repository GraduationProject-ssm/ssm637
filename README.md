...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=36)
...
|3|password|String|密码|是|
|4|jiaocaiguanli\_name|String|教材管理员姓名|是|
|5|sex\_types|Integer|性别|是|
|6|jiaocaiguanli\_phone|String|联系方式|是|
...
|8|jiaoshi\_id\_number|String|身份证号|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|id|Int|编号|否|
|2|jiaocai\_order\_uuid\_number|String|教材编号|是|
|3|jiaocai\_types|Integer|教材类型|是|
|4|jiaocai\_kucun\_number|Integer|教材库存|是|
|5|jiaocai\_new\_money|BigDecimal|教材价格|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|id|Int|编号|否|
|2|jiaocai\_churu\_inout\_uuid\_number|String|出入库流水号|是|
|3|jiaocai\_churu\_inout\_name|String|出入库名称|是|
|4|jiaocai\_churu\_inout\_types|Integer|出入库类型|是|
|5|jiaocai\_churu\_inout\_content|String|备注|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|id|Int|编号|否|
|2|jiaocai\_churu\_inout\_id|Integer|出入库|是|
|3|jiaocai\_id|Integer|教材|是|
|4|jiaocai\_churu\_inout\_list\_number|Integer|操作数量|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|id|Int|编号|否|
|2|jiaoshishenqing\_uuid\_number|String|申请编号|是|
|3|jiaocai\_id|Integer|教材|是|
|4|jiaoshi\_id|Integer|教师|是|
|5|jiaoshishenqing\_number|Integer|申请数量|是|
|6|kecheng\_types|Integer|课程|是|
|7|banji\_types|Integer|班级|是|
|8|jiaoshishenqing\_yesno\_types|Integer|申请状态|是|
|9|jiaoshishenqing\_yesno\_text|String|申请结果|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|id|Int|编号|否|
|2|jiaoshishenqing\_id|Integer|教材|是|
|3|yonghu\_id|Integer|学生|是|
|4|jiaoshishenqing\_number|Integer|申请数量|是|
|5|xueshengshenqing\_yesno\_types|Integer|申请状态|是|
|6|xueshengshenqing\_yesno\_text|String|申请结果|是|
